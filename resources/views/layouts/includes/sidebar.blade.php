<div class="sidebar">
    <nav class="sidebar-nav">
        <ul class="nav">
            ...
            {{-- Financial Links --}}
            @canany(['view expenses', 'view partners', 'view partnerPayments', 'view transactions', 'view safe'])
                <li class="nav-item nav-dropdown">
                    <a class="nav-link nav-dropdown-toggle" href="#">
                    ...
                    <ul class="nav-dropdown-items">
                        ...
                        @can('view partners')
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.partners.index') }}">
                                    <i class="nav-icon icon-people"></i> {{ __('lang.partners') }}</a>
                            </li>
                        @endcan
                        @can('view partnerPayments')
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.partnerPayments.index') }}">
                        ...
                        @can('view safe')
                            <li class="nav-item">
                                <a class="nav-link" href="{{ route('admin.safe.show') }}">
