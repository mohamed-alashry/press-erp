                                ...
                                <div class="col-12 col-md-2 text-md-center">
                                    <div class="row mb-2 mb-md-0">
                                        <div class="col-4 d-block d-md-none">
                                            <strong>{{ __('lang.credit_balance') }}</strong>
                                        </div>
                                        <div class="col-8 col-md-12">{{ $supplier->credit_balance }}</div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-2 text-md-center">
                                    <div class="row mb-2 mb-md-0">
                                        ...
                                        <div class="col-8 col-md-12">{{ $supplier->debit_balance }}</div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-2 text-md-center">
                                    <div class="row mb-2 mb-md-0">
                                        ...
                                        <div class="col-8 col-md-12">
                                            {{ $supplier->credit_balance - $supplier->debit_balance }}
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12 col-md-2 text-md-center">
